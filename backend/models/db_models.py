...
class ValueBet(Base):
    ...
    verdict: Mapped[str | None] = mapped_column(String(20), nullable=True, default=None)
    action: Mapped[str | None] = mapped_column(String(10), nullable=True, default=None)
    min_edge: Mapped[float | None] = mapped_column(Float, nullable=True, default=None)
    max_edge: Mapped[float | None] = mapped_column(Float, nullable=True, default=None)
    why_line: Mapped[str | None] = mapped_column(String(500), nullable=True, default=None)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    fixture: Mapped["Fixture"] = relationship("Fixture")
